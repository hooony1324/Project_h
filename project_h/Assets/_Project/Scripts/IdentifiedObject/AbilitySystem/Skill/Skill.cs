...
public class Skill : IdentifiedObject
{
    ...
    public float Cooldown => Owner == null ? currentData.cooldown.defaultValue : currentData.cooldown.GetValue(Owner.StatsComponent);
    ...
    public float CastTime => Owner != null ? currentData.castTime.GetValue(Owner.StatsComponent) : currentData.castTime.defaultValue;
