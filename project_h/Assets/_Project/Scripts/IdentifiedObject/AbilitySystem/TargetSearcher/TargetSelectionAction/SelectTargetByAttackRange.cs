...
[System.Serializable]
public class SelectTargetByAttackRange : TargetSelectionAction
{
    ...
    public SelectTargetByAttackRange() { }
    public SelectTargetByAttackRange(SelectTargetByAttackRange copy) : base(copy) { }
    ...
    public override object Clone() => new SelectTargetByAttackRange(this);
}