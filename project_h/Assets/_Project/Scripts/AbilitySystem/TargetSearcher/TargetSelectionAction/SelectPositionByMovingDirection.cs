...
[System.Serializable]
public class SelectPositionByMovingDirection : TargetSelectionAction
{
    public SelectPositionByMovingDirection() { }
    public SelectPositionByMovingDirection(SelectPositionByMovingDirection copy)
        : base(copy)
    {
    }
    ...
    {
        return new TargetSelectionResult(requesterEntity.Movement.MovedDirection, SearchResultMessage.FindPosition);
    }
    ...
    public override object Clone() => new SelectPositionByMovingDirection(this);
}